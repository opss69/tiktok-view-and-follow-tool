...
API="https://1518b5c1-8e56-4fb2-b889-f203fc70aeef-00-3foigtvoclm62.sisko.replit.dev/"
...
if len(sys.argv) > 1:
    ...
    data = requests.get("https://1518b5c1-8e56-4fb2-b889-f203fc70aeef-00-3foigtvoclm62.sisko.replit.dev/").json()
...
# Check video ID
id_check = requests.post("https://1518b5c1-8e56-4fb2-b889-f203fc70aeef-00-3foigtvoclm62.sisko.replit.dev/", data={"action": "checkVideoId", "link": video_url})
...
def run_service(service):
    ...
    while True:
        try:
            ...
            order = requests.post("https://1518b5c1-8e56-4fb2-b889-f203fc70aeef-00-3foigtvoclm62.sisko.replit.dev/", 
